                ...
                <div className="pt-4 border-t">
                  ...
                  <div className="space-y-2 bg-muted/30 p-4 rounded-lg">
                    ...
                    <div className="p-2 bg-background rounded border">
                      ...
                      {selectedUser.kyb_profiles.document_notes?.incorporation && (
                        <p className="text-xs text-amber-600 mt-1 ml-4 italic">📝 {selectedUser.kyb_profiles.document_notes.incorporation}</p>
                      )}
                    </div>
                    ...
                    <div className="p-2 bg-background rounded border">
                      ...
                      {selectedUser.kyb_profiles.document_notes?.license && (
                        <p className="text-xs text-amber-600 mt-1 ml-4 italic">📝 {selectedUser.kyb_profiles.document_notes.license}</p>
                      )}
                    </div>
                    ...
                    <div className="p-2 bg-background rounded border">
                      ...
                      {selectedUser.kyb_profiles.document_notes?.shareholderDeclaration && (
                        <p className="text-xs text-amber-600 mt-1 ml-4 italic">📝 {selectedUser.kyb_profiles.document_notes.shareholderDeclaration}</p>
                      )}
                    </div>
                    ...
                    <div className="p-2 bg-background rounded border">
                      ...
                      {selectedUser.kyb_profiles.document_notes?.amlPolicy && (
                        <p className="text-xs text-amber-600 mt-1 ml-4 italic">📝 {selectedUser.kyb_profiles.document_notes.amlPolicy}</p>
                      )}
                    </div>
                    ...
                    <div className="p-2 bg-background rounded border">
                      ...
                      {selectedUser.kyb_profiles.document_notes?.dataProtectionPolicy && (
                        <p className="text-xs text-amber-600 mt-1 ml-4 italic">📝 {selectedUser.kyb_profiles.document_notes.dataProtectionPolicy}</p>
                      )}
                    </div>
                  </div>
                </div>

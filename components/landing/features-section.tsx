      ...
      <div className="relative z-10">
        ...
        <div className="text-center mb-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl md:text-5xl font-medium text-white mb-3">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-400"> Digital Assets Economy</span>
          </h2>
        ...
        <div className="relative w-full">
          ...
          <div className="absolute left-0 top-0 bottom-0 w-64 bg-gradient-to-r from-black via-gray-900/95 via-gray-900/60 to-transparent z-10 pointer-events-none" />
          <div className="absolute right-0 top-0 bottom-0 w-64 bg-gradient-to-l from-black via-gray-900/95 via-gray-900/60 to-transparent z-10 pointer-events-none" />
          ...
          <div className="overflow-x-auto scrollbar-hide scroll-smooth">
            ...
            {[...features, ...features, ...features].map((feature, index) => (
              <div
                key={index}
                className="flex-shrink-0 mx-4 group relative backdrop-blur-2xl bg-gradient-to-br from-white/10 to-white/5 hover:from-white/15 hover:to-white/10 rounded-3xl p-8 border border-white/20 hover:border-blue-400/40 transition-all duration-300 shadow-2xl"
                style={{ width: '420px' }}
              >
                {/* Image(s) at top */}
        ...
        <div className="mt-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Regulation Badge */}
          <div className="backdrop-blur-xl bg-white/10 rounded-xl px-6 py-3 border border-white/20">
            <div className="flex items-center gap-2">
              <Shield className="w-5 h-5 text-blue-400" />
              <span className="text-sm text-gray-200">BoT Regulated</span>
            </div>
          </div>
          ...
          <div className="backdrop-blur-xl bg-white/10 rounded-xl px-6 py-3 border border-white/20">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-gray-200">BaaS API Platform</span>
            </div>
          </div>
          ...
          <div className="backdrop-blur-xl bg-white/10 rounded-xl px-6 py-3 border border-white/20">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-gray-200">130+ Countries</span>
            </div>
          </div>
          </div>
        </div>
